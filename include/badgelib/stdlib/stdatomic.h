...
extern _Bool atomic_flag_test_and_set(atomic_flag volatile *);
#define atomic_flag_test_and_set(PTR) __atomic_test_and_set((PTR), __ATOMIC_SEQ_CST)
extern _Bool atomic_flag_test_and_set_explicit(atomic_flag volatile *, memory_order);
...
extern void atomic_flag_clear_explicit(atomic_flag volatile *, memory_order);
